function searchAction() {
  ...
  fetch("https://api.themoviedb.org/3/search/movie?query="+valDeBusq+"&include_adult=false&language=es&page=1&api_key=da2bc34b7d1c815449e218aadeea9272")
    .then(data => data.json())
    .then(data => {
      ...
      if (resultados.length !== 0){
        ...
        document.querySelector('.cards-container').insertAdjacentHTML ("afterbegin",'<h1>Película no encontrada </h1>')
      }
      cargarPeliculas ()
    })
}
